...
from .views import SolicitudesViewSet, ConsultasViewSet
...
urlpatterns = [
    ...
    path('modificarSolicitud/<int:solicitud_id>/', views.modificar_solicitud, name='modificar_solicitud'),# path para modificar solicitudes
    path('eliminarSolicitud/<int:solicitud_id>/', views.eliminar_solicitud, name='eliminar_solicitud'),# path para eliminar solicitudes
    path('eliminarConsulta/<int:consulta_id>/', views.eliminar_consulta, name='eliminar_consulta'),# path para eliminar consultas
